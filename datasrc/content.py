...
image_mouseicons = Image("mouseicons", "ui/mouse.png", 1)
...
container.images.Add(image_mouseicons)
...
set_mouseicons = SpriteSet("mouseicons", image_mouseicons, 4, 3)
...
container.spritesets.Add(set_mouseicons)
...
container.sprites.Add(Sprite("mouse1", set_mouseicons, 0,0,2,3))
container.sprites.Add(Sprite("mouse2", set_mouseicons, 2,0,2,3))
