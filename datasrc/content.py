...
image_adminicon = Image("adminicon", "admin_icon.png")
...
container.images.Add(image_adminicon)
...
set_adminicon = SpriteSet("adminicon", image_adminicon, 2, 2)
...
container.spritesets.Add(set_adminicon)
...
container.sprites.Add(Sprite("adminicon", set_adminicon, 0,0,2,2))
