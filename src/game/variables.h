...
MACRO_CONFIG_INT(SvRescue, sv_rescue, 0, 0, 1, CFGFLAG_SAVE|CFGFLAG_SERVER, "Set to 1 to allow use /r command")
MACRO_CONFIG_INT(SvRescueCooldown, sv_rescue_cooldown, 10, 0, 60, CFGFLAG_SAVE|CFGFLAG_SERVER, "Time beetwen '/r' uses")
